...
t2 = input()
t3 = input()
schedule.every().day.at("10:" + t1 + ":" + t2).do(trading.fetch_val)
schedule.every().day.at("10:"+ t1 + ":" + str(int(t2)+10)).do(trading.start)

# At the end of day save data in day wise
schedule.every().day.at("10:"+t3+":10").do(trading.save_day)

# At the end of each week, save data in week tables.
schedule.every().friday.at("10:"t3+":10").do(trading.save_week)

# At the end of each month save data in month tables.
schedule.every().day.at("16:"t3+":10").do(tradingn.save_month)
